...
지휘 일정은 항상 출석 대상입니다. 행정 일정은 단장이 등록·수정할 때 '출석 받기'를 켜야 출석 대상이 되며(노션 '전체 일정'의 '출석 받기' 칸), 이후 흐름은 연습과 같습니다. 출석 기록이 생긴 행정 일정은 출석 받기를 끌 수 없습니다. 노션에서 유형만 '행정'으로 두고 분류가 '지휘'인 일정은 지휘 일정으로 취급해 계속 출석 대상입니다.
